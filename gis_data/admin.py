...
from .models import PointOfInterest, RoadSegment, ScenicArea
...
class RoadSegmentAdmin(admin.GISModelAdmin):
    ...
    fieldsets = (
        ("Identificazione", {"fields": ("name", "osm_id", "highway")}),
        ("Geometria", {"fields": ("geometry", "length_m")}),
        ("Proprietà Stradali", {"fields": ("maxspeed", "oneway", "surface", "lanes")}),
        (
