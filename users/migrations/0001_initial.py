    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('VISITOR', 'Visitor (Unauthenticated)'), ('SUBSCRIBED', 'Subscribed User'), ('ADMIN', 'Administrator')], default='SUBSCRIBED', max_length=20, verbose_name='User Role')),
            ...
            options={
                'verbose_name': 'ApexGPS User',
                'verbose_name_plural': 'ApexGPS Users',
            },
            managers=[
