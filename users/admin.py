...
class CustomUserAdmin(UserAdmin):
    ...
    def make_subscribed(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} utenti segnati come 'Utenti Iscritti'."
        )
    ...
    def make_admin(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} utenti segnati come 'Amministratori'."
        )
    ...
    def make_visitor(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} utenti segnati come 'Visitatori'."
        )
